...
namespace copp {
    namespace allocator {
        ...
        stack_allocator_windows::stack_allocator_windows() UTIL_CONFIG_NOEXCEPT {}

        stack_allocator_windows::~stack_allocator_windows() {}

        void stack_allocator_windows::allocate(stack_context &ctx, std::size_t size) UTIL_CONFIG_NOEXCEPT {
