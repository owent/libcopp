...
namespace copp {
    namespace allocator {
        ...
        LIBCOPP_COPP_API stack_allocator_posix &stack_allocator_posix::operator=(const stack_allocator_posix &) LIBCOPP_MACRO_NOEXCEPT {
            return *this;
        }
        ...
        LIBCOPP_COPP_API stack_allocator_posix &stack_allocator_posix::operator=(stack_allocator_posix &&) LIBCOPP_MACRO_NOEXCEPT {
            return *this;
        }
#endif
