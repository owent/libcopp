...
namespace copp {
    ...
    bool stack_traits::is_unbounded() COPP_MACRO_NOEXCEPT { return true; }

    std::size_t stack_traits::page_size() COPP_MACRO_NOEXCEPT { return detail::pagesize(); }
    ...
    std::size_t stack_traits::minimum_size() COPP_MACRO_NOEXCEPT { return MIN_STACKSIZE; }
