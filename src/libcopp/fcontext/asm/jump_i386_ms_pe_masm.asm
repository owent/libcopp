...
copp_jump_fcontext PROC EXPORT
    ; fourth arg of copp_jump_fcontext() == flag indicating preserving FPU
    mov  ecx, [esp+010h]
...
nxt1:
    ; first arg of copp_jump_fcontext() == context jumping from
    mov  eax, [esp+030h]

    ; store ESP (pointing to context-data) in EAX
    mov  [eax], esp

    ; second arg of copp_jump_fcontext() == context jumping to
    mov  edx, [esp+034h]

    ; third arg of copp_jump_fcontext() == value to be returned after jump
    mov  eax, [esp+038h]
