...
copp_make_fcontext PROC EXPORT
    mov  eax,         [esp+04h]     ; load 1. arg of copp_make_fcontext, pointer to context stack (base)
    ...
    mov  ecx,         [esp+04h]     ; load 1. arg of copp_make_fcontext, pointer to context stack (base)
    mov  [eax+018h],  ecx           ; save address of context stack (base) in fcontext_t
    mov  edx,         [esp+08h]     ; load 2. arg of copp_make_fcontext, context stack size
    ...
    mov  ecx,         [esp+0ch]     ; load 3. arg of copp_make_fcontext, pointer to context function
