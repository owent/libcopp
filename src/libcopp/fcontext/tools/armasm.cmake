...
if(MSVC)
	...
	execute_process (
		COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BIN} "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_NAME_MAKE}.asm"
	...
	execute_process (
		COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BIN} "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_NAME_JUMP}.asm"
		"${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_JUMP}"
		WORKING_DIRECTORY "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}"
	)

	execute_process (
		COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BIN} "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_NAME_ONTOP}.asm"
