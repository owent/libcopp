...
execute_process (
    COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BINC} -c -x assembler-with-cpp "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_FILE_MAKE}" -o "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_MAKE}"
...
execute_process (
    COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BINC} -c -x assembler-with-cpp "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_FILE_JUMP}" -o "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_JUMP}"
...
execute_process (
    COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BINC} -c -x assembler-with-cpp "${PROJECT_LIBCOPP_FCONTEXT_ASM_DIR}/${PROJECT_LIBCOPP_FCONTEXT_SRC_FILE_ONTOP}" -o "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_ONTOP}"
