...
if(MSVC)
	...
	execute_process (
        COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BIN} ${LIBCOPP_FCONTEXT_AS_TOOL_OPTION} "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR_WINPATH}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_MAKE}"
        "${PROJECT_LIBCOPP_FCONTEXT_SRC_NAME_MAKE}.asm"
        WORKING_DIRECTORY "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}"
    )
	
	execute_process (
        COMMAND ${LIBCOPP_FCONTEXT_AS_TOOL_BIN} ${LIBCOPP_FCONTEXT_AS_TOOL_OPTION} "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR_WINPATH}/${PROJECT_LIBCOPP_FCONTEXT_BIN_NAME_JUMP}"
        "${PROJECT_LIBCOPP_FCONTEXT_SRC_NAME_JUMP}.asm"
        WORKING_DIRECTORY "${PROJECT_LIBCOPP_FCONTEXT_BIN_DIR}"
    )
