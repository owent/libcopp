...
if (NOT LIBCOPP_FCONTEXT_OS_PLATFORM)
	...
	if(LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "unknown" OR 
		LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "i386" OR
		LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "i686" OR
		LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "x86_64" OR
		LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "amd64"
		)
	...
	elseif(
		LIBCOPP_FCONTEXT_OS_PLATFORM MATCHES "^armv5" OR 
		LIBCOPP_FCONTEXT_OS_PLATFORM MATCHES "^armv7" OR
		LIBCOPP_FCONTEXT_OS_PLATFORM MATCHES "^armeabi"
	)
		set(LIBCOPP_FCONTEXT_OS_PLATFORM "arm")
	elseif(
			LIBCOPP_FCONTEXT_OS_PLATFORM MATCHES "^arm64" OR 
			LIBCOPP_FCONTEXT_OS_PLATFORM MATCHES "^aarch64"
		)
			set(LIBCOPP_FCONTEXT_OS_PLATFORM "arm64")
    endif()

    if (LIBCOPP_FCONTEXT_OS_PLATFORM STREQUAL "unknown")
        EchoWithColor(COLOR RED "Can not detect the processor, please add -DLIBCOPP_FCONTEXT_OS_PLATFORM=arm/arm64/i386/x86_64/combined/mips32/mips64/ppc32/ppc64 to help us to find target processor")
