...
public:
    ...
    public:
        ...
        const shell_stream_opr &operator<<(shell_font_style::ShellFontSpec style) const {
            open(style);
            return (*this);
        }

        const shell_stream_opr &operator<<(shell_font_style::ShellFontColor style) const {
            open(style);
            return (*this);
        }

        const shell_stream_opr &operator<<(shell_font_style::ShellFontBackgroundColor style) const {
            open(style);
            return (*this);
        }
