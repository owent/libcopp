...
CASE_TEST(coroutine_task_fiber, custom_action) {
    ...
    {
        task_ptr_type co_task         = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_action());
        task_ptr_type co_another_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_action()); // share action
...
CASE_TEST(coroutine_task_fiber, functor_action) {
    typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
    task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_functor());
    g_test_coroutine_task_fiber_status          = 0;
...
CASE_TEST(coroutine_task_fiber, function_action) {
    {
        typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
        task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_function_1);
        g_test_coroutine_task_fiber_status          = 0;
    ...
    {
        typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
        task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_function_2);
        g_test_coroutine_task_fiber_status          = 0;
...
static void test_context_task_fiber_function_3(void *) {
    ...
    CASE_EXPECT_EQ(cotask::EN_TS_RUNNING, cotask::this_task::get<cotask::task<test_context_task_fiber_default_test_macro> >()->get_status());
...
CASE_TEST(coroutine_task_fiber, coroutine_context_yield) {
    typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
    task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_function_3);
    g_test_coroutine_task_fiber_status          = 0;
...
CASE_TEST(coroutine_task_fiber, mem_function_action) {
    ...
    task_ptr_type                  co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(&test_context_task_fiber_mem_function::real_run, &obj);
    g_test_coroutine_task_fiber_status           = 0;
...
CASE_TEST(coroutine_task_fiber, next) {
...

    {
        ...
        task_ptr_type co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_next_action(15, 0));
    ...
    {
        g_test_coroutine_task_fiber_status = 0;
        task_ptr_type co_task_a      = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_next_action(2, 1));
        task_ptr_type co_task_b      = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_function_1);
...
CASE_TEST(coroutine_task_fiber, functor_drived_action) {
    ...
    task_ptr_type                               co_task = cotask::task<test_context_task_fiber_default_test_macro>::create_with<test_context_task_fiber_functor_drived>(alloc, 0, 0, 1, 3);
    CASE_EXPECT_EQ(0, co_task->start());
}
...
CASE_TEST(coroutine_task_fiber, priavte_buffer) {
    typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
    task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_priavte_buffer, 16384, 256);
...
CASE_TEST(coroutine_task_fiber, kill_and_timeout) {
    typedef cotask::task<test_context_task_fiber_default_test_macro>::ptr_t task_ptr_type;
    task_ptr_type                 co_task = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_timeout, 16384, 256);
...
static int test_context_task_fiber_await_1(void *) {
    ...
    cotask::task<test_context_task_fiber_default_test_macro>::self_t *other_task = *reinterpret_cast<cotask::task<test_context_task_fiber_default_test_macro>::self_t **>(priv_data);
...
CASE_TEST(coroutine_task_fiber, await_task) {
    ...
    // normal
    {
        task_ptr_type co_task_1 = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_await_1, 16384, sizeof(cotask::task<test_context_task_fiber_default_test_macro>::self_t *));
        task_ptr_type co_task_2 = cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_await_2, 16384);
...
CASE_TEST(coroutine_task_fiber, then) {
    ...
    co_task->then(test_context_task_fiber_next_action(127, 5))->then(test_context_task_fiber_then_action_func, &g_test_coroutine_task_fiber_status);
...
typedef cotask::task<test_context_task_fiber_stack_pool_test_macro_coroutine> test_context_task_fiber_stack_pool_test_task_t;
...
CASE_TEST(coroutine_task_fiber, then_with_stack_pool) {
    ...
    task_ptr_type tp = test_context_task_fiber_stack_pool_test_task_t::create(test_context_task_fiber_next_action(15, 0), base_alloc);
    tp->then(test_context_task_fiber_next_action(127, 15))->then(test_context_task_fiber_then_action_func, &g_test_coroutine_task_fiber_status);

    CASE_EXPECT_EQ(3, stack_pool->get_limit().used_stack_number);
    tp->start();
    CASE_EXPECT_EQ(1, stack_pool->get_limit().used_stack_number);

    tp->then(test_context_task_fiber_next_action(255, 127))->then(test_context_task_fiber_then_action_func, &g_test_coroutine_task_fiber_status);
...
CASE_TEST(coroutine_task_fiber, mt_run_competition) {
    ...
    for (int i = 0; i < test_context_task_fiber_test_mt_task_num; ++i) {
        task_pool.push_back(cotask::task<test_context_task_fiber_default_test_macro>::create(test_context_task_fiber_test_action_mt_thread(), 16 * 1024)); // use 16KB for stack
    }
    ...
    CASE_EXPECT_EQ(g_test_context_task_fiber_test_mt_run_times * test_context_task_fiber_test_mt_task_num, g_test_context_task_fiber_test_atomic.load());
    CASE_MSG_INFO() << "Fiber tasks are run on " << g_test_context_task_fiber_test_mt_max_run_thread_number << " threads at most."
                    << std::endl;
}
