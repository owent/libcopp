...
struct test_future_for_std_coroutine_waker_t {
    ...
    test_future_for_std_coroutine_waker_t() {}

    // for call_for_coroutine_fn_failed
    test_future_for_std_coroutine_waker_t(int32_t code) {}

    void operator()(test_poll_t &out) {}
...
static test_task_t call_for_coroutine_fn_runtime() {
    //
    co_await call_for_coroutine_fn_failed(403);
}
