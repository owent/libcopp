...
CASE_TEST(core, fcontext) {
  ...
  test_core_fcontext_a_func =
      copp::fcontext::copp_make_fcontext(test_core_fcontext_stack_a + sizeof(test_core_fcontext_stack_a),
                                         sizeof(test_core_fcontext_stack_a), test_core_fcontext_func_a);
  test_core_fcontext_b_func =
      copp::fcontext::copp_make_fcontext(test_core_fcontext_stack_b + sizeof(test_core_fcontext_stack_b),
