...
using benchmark_generator_future_type = copp::generator_channel_future<benchmark_no_trivial_message_t>;
...
int main(int argc, char *argv[]) {
  puts("###################### std callable - reuse channel generator - no trivial ###################");
  printf("########## Cmd:");
