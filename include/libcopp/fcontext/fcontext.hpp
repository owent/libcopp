...
# if defined(_WIN32)
#  include "libcopp/fcontext/detail/fcontext_x86_64_win.hpp"
# else
#  include "libcopp/fcontext/detail/fcontext_x86_64.hpp"
# endif
// i386
...
# if defined(_WIN32)
#  include "libcopp/fcontext/detail/fcontext_i386_win.hpp"
# else
#  include "libcopp/fcontext/detail/fcontext_i386.hpp"
# endif
// arm
#elif defined(__arm__) || defined(__thumb__) || defined(__TARGET_ARCH_ARM) \
    || defined(__TARGET_ARCH_THUMB) || defined(_ARM) || defined(_M_ARM)
# include "libcopp/fcontext/detail/fcontext_arm.hpp"
// mips
#elif (defined(__mips) && __mips == 1) || defined(_MIPS_ISA_MIPS1) \
    || defined(_R3000)
# include "libcopp/fcontext/detail/fcontext_mips.hpp"
// powerpc
...
# include "libcopp/fcontext/detail/fcontext_ppc.hpp"
#elif defined(__sparc__) || defined(__sparc)
// sparc or sparc64
# include "libcopp/fcontext/detail/fcontext_sparc.hpp"
#else
...
extern "C" 
intptr_t COPP_BOOST_CONTEXT_CALLDECL copp_jump_fcontext(fcontext_t * ofc, fcontext_t const* nfc, intptr_t vp, bool preserve_fpu = true);
extern "C" 
