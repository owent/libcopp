...
class LIBCOPP_COTASK_API_HEAD_ONLY task_action_function : public impl::task_action_impl {
 ...
 private:
  ...
  struct invoker<Tz, true> {
    LIBCOPP_UTIL_FORCEINLINE static int invoke(task_action_function &in, void *priv_data) {
...
class LIBCOPP_COTASK_API_HEAD_ONLY task_action_mem_function : public impl::task_action_impl {
 ...
 private:
  ...
  template <class Tz>
  struct invoker<Tz, true> {
    LIBCOPP_UTIL_FORCEINLINE static int invoke(task_action_mem_function &in, void *priv_data) {
